...
export default function BookDetails() {
  ...
  const fetchBookData = async () => {
    ...
    try {
      ...
      // Fetch related books (fetch all books and filter out current book)
              ...
              {relatedBooks.map((book) => (
                ...
                >
                  ...
                  <div className="mt-3">
                    ...
                    <p
                      className={`text-xs font-medium mt-1 ${book.status === "Out Of Stock"
                        ? "text-red-500"
                        : "text-green-600"
                        }`}
                    >
