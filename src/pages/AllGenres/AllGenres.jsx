...
//                 key={book.id}
//                 onClick={() => navigate(`/book/${book.id}`)}
//                 className="group cursor-pointer rounded-xl overflow-hidden bg-white ring-1 ring-transparent shadow-sm hover:-translate-y-1 hover:shadow-xl hover:ring-sky-100 transition-all duration-300 h-full flex flex-col"
//               >
//                 <img
//                   src={book.image}
//                   alt={book.title}
...
//                   <div className="text-[11px] uppercase text-orange-500 font-semibold mb-1">
//                     {book.category || "General"}
//                   </div>
//                   <h3 className="text-sm font-semibold line-clamp-2 mb-2 group-hover:text-sky-600 transition-colors">
//                     {book.title}
//                   </h3>
...
//                     <div className={`mt-2 font-medium text-xs sm:text-sm ${stockColor}`}>
//                       {status}
//                     </div>
//                   </div>
//                 </div>
